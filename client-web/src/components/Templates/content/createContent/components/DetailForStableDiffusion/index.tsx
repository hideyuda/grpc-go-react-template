...
function DetailForStableDiffusion(
  props: {
    prompt: string;
  ...
  return (
    <CustomBox>
      <CustomTypography variant="h5">Prompt And DetailForStableDiffusion</CustomTypography>
      <CustomBox mt={3}>
...
export default DetailForStableDiffusion;
