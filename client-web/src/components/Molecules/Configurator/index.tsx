...
import ConfiguratorRoot from "components/Molecules/Configurator/ConfiguratorRoot";
...
function Configurator(): JSX.Element {
  ...
  return (
    <ConfiguratorRoot variant="permanent" ownerState={{ openConfigurator }}>
      ...
      >
        <CustomBox>
          <CustomTypography variant="h5">Material UI Configurator</CustomTypography>
      ...
      <CustomBox pt={0.5} pb={3} px={3}>
        ...
        <Divider />
        <CustomBox display="flex" justifyContent="space-between" alignItems="center" lineHeight={1}>
